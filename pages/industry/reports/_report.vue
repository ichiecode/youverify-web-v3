<template>
  <div>
    ...
    >
      <div
        class="px-4 sm:px-6 md:px-8 h-20 flex items-center justify-between max-w-screen-xl w-full"
      >
    ...
    <div class="px-4 md:px-0 max-w-3xl mx-auto w-full mt-8">
      <nuxt-link
        to="/industry/reports"
        class="inline-flex items-center justify-center relative box-border outline-0 m-0 select-none gap-2 whitespace-nowrap px-4 py-1.5 text-sm no-underline rounded transition-colors bg-transparent hover:bg-gray-100 text-gray-800 border-0"
      >
        <svg
