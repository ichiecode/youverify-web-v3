<template>
  <div>
    <div class="bg-blue-100">
      <header
        class="max-w-screen-xl mx-auto px-8 w-full h-full md:max-h-120 relative flex justify-center flex-col py-8"
      >
        ...
        <div class="w-full py-16 md:py-24">
          <h1
            class="md:text-4xl text-2xl mb-2 md:mb-5 font-bold text-center text-blue-200"
          >
            Articles, insights & tips!
          </h1>
          <h2 class="md:text-lg text-base font-normal text-black text-center">
            Increase your knowledge by reading articles with this blog. Let’s
            start
          </h2>
        </div>
      </header>
    </div>
    <main class="max-w-screen-xl mx-auto w-full py-4 md:py-14">
