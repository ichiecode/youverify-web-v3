  ...
  <main class="w-full max-w-screen-xl mt-24 px-4 md:px-8 mx-auto">
    ...
    <section v-else class="">
      <article v-if="guide" class="mt-16 md:mt-28 mb-12">
        ...
        <a
          ...
          class="outline-0 inline-flex items-center gap-2 my-10 select-none whitespace-nowrap bg-blue text-white hover:bg-blue-300 font-medium px-8 py-4 text-sm capitalize transition-colors rounded"
        >
          Download Guide (PDF)
          <svg
            width="24"
    ...
    <section class="my-20">
      ...
      <div class="flex justify-center">
        <nuxt-link
          to="/resources/compliance-guides-and-reports"
