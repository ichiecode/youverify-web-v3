        ...
        <div class="flex-col-reverse md:flex-row flex justify-center">
          <div class="md:w-3/6">
            <h2 class="text-white max-w-screen-lg mt-8">
              Build the bank of the future with instant verification
            </h2>
            ...
            <div class="mt-10 flex items-center">
              <h4 class="text-white">Insurance Building with vForms</h4>
    ...
    <div id="more">
      ...
      >
        ...
        <div class="sm:w-4/12 w-full sm:mt-0 mt-8">
          <h3>Alternative Credit Score</h3>
          <p class="mt-4">
          ...
          <div class="mx-auto">
            <div class="text-center w-full mb-12 sm:mb-16 lg:mb-20">
              <h3 class="text-dark font-display">
                Try out some of our templates for Digital Banking
              </h3>
            ...
            <div class="relative bg-white">
              <a href="#" class=""
                ...
                <div class="pt-4 pb-6 px-7">
                  ...
                  <p class="">
                    Get automatic and on-demand data refresh on data from
                  ...
                  <div class="mt-3 flex">
                    ...
                    ></a>
                    <a
                      href="https://os.dev.youverify.co/auth/login"
                      target="_blank"
                      rel="noreferrer"
                      class="
                        text-base
          ...
          <li>
            <div class="relative bg-white">
              <a href="#" class=""
                ...
                <div class="pt-4 pb-6 px-7">
                  <h4 class="my-4">Token Validation</h4>
                  <p class="">
                    Get automatic and on-demand data refresh on data from
                    onboarding customers.
                  </p>
          ...
          <li>
            <div class="relative bg-white">
              <a href="#" class=""
                ...
                <div class="pt-4 pb-6 px-7">
                  <h4 class="my-4">Loan Request Management</h4>
                  <p class="">
                    Get automatic and on-demand data refresh on data from
                    onboarding customers.
                  </p>
          ...
          <li>
            <div class="relative bg-white">
              <a href="#" class=""
                ...
                <div class="pt-4 pb-6 px-7">
                  <h4 class="my-4">Account Opening</h4>
                  <p class="">
                    Get automatic and on-demand data refresh on data from
                    onboarding customers.
                  </p>
